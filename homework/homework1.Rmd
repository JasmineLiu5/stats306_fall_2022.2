...
```
Jasmine Liu@LAPTOP-B8F1DKD2 MINGW64 ~/Documents/GitHub/stats306_fall_2022.2 (main)
$ git config --global user.name "Jasmine Liu"

Jasmine Liu@LAPTOP-B8F1DKD2 MINGW64 ~/Documents/GitHub/stats306_fall_2022.2 (main)
$ git config --global user.email "shanyu@umich.edu"
```
### Using the log
...
* Commit id:a9e58afd6af370ded27987703b97318d2506e14b
* Author:Jasmine Liu<shanyu@umich.edu>
* Date:Tue Sep 13 10:23:43 2022 -0400
* Message: Update homework1. Rmd
...
> YOUR ANSWER
It provides an instruction for me to use this command correctly.
...
> YOUR ANSWER
It's telling me that my branch is ahead of 'main' by 1 commit. 
and the changes hasn't been staged for commit.
...
```
commit e8d45fa58b00498e648ec7a5bc540ee239d9bdce (HEAD -> main)
Author: Jasmine Liu <shanyu@umich.edu>
Date:   Tue Sep 13 11:17:26 2022 -0400
...
```
I am free this Wedsday mroning.
```
...
```{r fig.height = 10}
ggplot(txhousing, aes(x = city, y = median, color = city)) + 
  geom_point() + 
